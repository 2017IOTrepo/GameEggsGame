...
import com.example.a41448.huawu.utils.map_utils.BitmapUtil;
import com.example.a41448.huawu.utils.map_utils.Constants;
import com.example.a41448.huawu.utils.map_utils.FenceCreateDialog;
import com.example.a41448.huawu.utils.map_utils.FenceOperateDialog;
import com.example.a41448.huawu.utils.map_utils.MapUtil;
import com.example.a41448.huawu.utils.map_utils.ViewUtil;
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_activity_options:
                Intent intent = new Intent(PointActivity.this,CreateFenceOptions.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (operateType) {
            case R.id.btn_create_fence:
                mapUtil.baiduMap.setOnMapClickListener(PointActivity.this);
                break;
    ...
    private void initListener() {
        ...
        createCallback = new FenceCreateDialog.Callback() {
            ...
            public void onSureCallback(double radius, int denoise, int offset) {
                PointActivity.this.radius = radius;
                PointActivity.this.denoise = denoise;
                PointActivity.this.offset = offset;
        ...
        fenceListener = new OnFenceListener() {
            ...
            public void onCreateFenceCallback(CreateFenceResponse response) {
                ...
                if (StatusCodes.SUCCESS == response.getStatus()) {
                    ...
                    viewUtil.showToast(PointActivity.this,
            ...
            public void onDeleteFenceCallback(DeleteFenceResponse response) {
                viewUtil.showToast(PointActivity.this, response.getMessage());
            ...
            public void onFenceListCallback(FenceListResponse response) {
                ...
                if (0 == response.getSize()) {
                    ...
                    viewUtil.showToast(PointActivity.this, message.toString());

                    return;
                }

                viewUtil.showToast(PointActivity.this, getString(R.string.fence_operate_caption));
