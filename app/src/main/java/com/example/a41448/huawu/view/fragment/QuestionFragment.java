...
public class QuestionFragment extends android.support.v4.app.Fragment implements View.OnClickListener{
    ...
    private class QuestionHolder extends RecyclerView.ViewHolder {
        //提问人头像
       private RoundImageView question_peo_Image;
        //提问人名字
        ...
        public QuestionHolder(View itemView) {
            ...
            question_peo_Image = (RoundImageView) itemView.findViewById(R.id.question_peo_Image);
...
//                        into( holder.question_peo_Image );
        ...
        OkGo.<String>post( "http://47.95.7.169:8080/getQuestion")
                ...
                .execute( new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        List<com.example.a41448.huawu.base.JSON.Question> questiion_list =
                                JSON.parseArray( response.body(), com.example.a41448.huawu.base.JSON.Question.class );
                        for (int i = 0; i < questiion_list.size(); i++) {
                            com.example.a41448.huawu.base.JSON.Question question = questiion_list.get( i );
                            ...
                            Question question_1 = new Question( UserInfo.name, R.drawable.icon, str,
    ...
    private void initQuestion(){
            Question question_1 = new Question("丁逸群",R.drawable.icon,"十天前",
                    "美国",R.drawable.country_1,"在影视剧中，清朝皇帝的女儿为什么不叫“公主”，而叫“格格”呢 ","");
            mQuestions.add(question_1);
            Question question_2 = new Question("武智鹏",R.drawable.adj,"三天前",
                    "法国",R.drawable.country_2,"为什么人们常把随便乱说话的行为口做“信口雌黄”? ","");
            mQuestions.add(question_2);
            Question question_3 = new Question("杨旭",R.drawable.apple_pic,"刚刚",
                    "巴西",R.drawable.country_3,"为什么我们将购物的行为叫做“买东西”，而不是“买南北”呢","");
            mQuestions.add(question_3);
            Question question_4 = new Question("王浩",R.drawable.p1,"一天前",
                    "中国",R.drawable.country,"影视作品中的皇后为何要自称为“哀家”","");
