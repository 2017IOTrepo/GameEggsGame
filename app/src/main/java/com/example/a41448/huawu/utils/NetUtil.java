...
public class NetUtil {private static DecimalFormat df1 = new DecimalFormat("0.00000000000000");//格式化小数
            ...
            dialog.setPositiveButton("确定",
                    new android.content.DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            ...
                            activity.startActivityForResult(intent, OPEN_GPS_SUCCESS); // 设置完成后返回到原来的界面
